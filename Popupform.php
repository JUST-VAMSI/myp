...
@media only screen and (max-width:1000px)
{
   ...
   .button2{
    ...
    <h1 class="start">EVENT UPDATE FORM</h1>
    <form  action="poptest.php" method="post" class="text-center">
        <div class="container">
            <h1 class="end">EVENT UPDATE FORM</h1>
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-12">
                    <pre class="hide">Message:</pre> 
                </div>
                <div class="col-lg-6 col-sm-12">
                    <textarea rows="3" cols="40" name="message" placeholder="Message"></textarea>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6 col-sm-12">
                    <pre class="hide">Link:</pre> 
                </div>
                <div class="col-lg-6 col-sm-12">
                    <input type="text" name="elink" class="" placeholder="Link">
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6 col-sm-12">
            ...
            <div class="row">
                <div class="col-lg-12 col-sm-12">
                    <input type="submit" name="pop" class="button2">
                </div>
            </div>
        </div>
    </form>
